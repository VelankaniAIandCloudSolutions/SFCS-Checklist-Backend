...
def create_maintenance_activity(request):
    try:
        if request.method == 'POST':
            ...
            selected_machine_id = data.get('selectedMachine')
            ...
            selected_machine = Machine.objects.get(pk=selected_machine_id)
            ...
            for selected_year in data.get('selectedYears', []):
                ...
                for choice in data.get('dateChoices', {}).get('choices', []):
                    ...
                    for month in selected_months:
                        ...
                        print('calendar.moth_abbr', list(calendar.month_abbr))
                        ...
                        month_index = month_abbr_list.index(matched_month)
